...
$busca = mysqli_query($conexao,$sql);
    while($array = mysqli_fetch_array($busca)) {
        ...
        $nomeplano = $array['plano'];
    
        ?>
        <tr>
        <td><?php echo $nomeplano ?></td>
        
        <td><a class="btn btn-warning" href="editar_plano.php?id=<?php echo $id_plano ?>" role="button"><i class="fas fa-edit"></i>&nbsp;Editar</a>
        <a class="btn btn-danger" href="deletar_plano.php?id=<?php echo $id_plano ?>" role="button"><i class="fas fa-trash-alt"></i>&nbsp;Excluir</a></td>
    </tr>
<?php } ?>
</table>
    </div>
